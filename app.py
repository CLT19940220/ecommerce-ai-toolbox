...
# 🔑 填入你的百度API密钥
API_KEY = "RMFLacjbNJG0LWikHzI5bOjQ"
SECRET_KEY = "tpvlSDj5vFpDSbPrzl26jgrzUtXAllYg"

# 初始化页面
st.set_page_config(page_title="电商AI美工工具箱 - AI抠图|换白底|高清修复|智能扩图", page_icon="🛠️", layout="wide")
